...
$dictionary['APO_SLAWeeklyCalendars'] = array(
    ...
    array (
        ...
        array (
            ...
            array (
                'type' => 'callback',
                'callback' => 'function(formname,nameIndex){if($("#" + nameIndex).val()=="0"){add_error_style(formname,nameIndex,"'.$app_strings['ERR_MISSING_REQUIRED_FIELDS'].' '.$app_strings['LBL_DAYOFTHEWEEK'].'"); return false;}; return true;}',
            ),
        ),
    ...
    array(
        array(
            ...
            'errormessages' =>
            array(
                "ERR_DUP_DAYOFWEEK_CALENDAR",
            ),
        ),       
        array(
            'name' => 'uniqueNameDayofWeek',
            'fields' =>
            array(
                'name',
                'dayoftheweek',
